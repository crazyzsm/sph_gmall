...
@Component
@Aspect
public class GmallCacheAspectOld {
    ...
    //  定义一个环绕通知！
    @SneakyThrows
    @Around("@annotation(com.arzhu.sph_gmall.common.cache.GmallCacheOld)")
    public Object gmallCacheAspectMethod(ProceedingJoinPoint point){
        ...
        GmallCacheOld gmallCacheOld = methodSignature.getMethod().getAnnotation(GmallCacheOld.class);
        //   获取到注解上的前缀
        String prefix = gmallCacheOld.prefix();
        //  组成缓存的key！ 获取方法传递的参数
